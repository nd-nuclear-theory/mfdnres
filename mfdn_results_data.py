    ...
    """
        ...
        Attributes:
            self.params (dictionary):  Container for properties of run.
                ...
                There are only four entries in params for MFDnResultsData: hw, Nmin,
                Nmax, and the tuple (Z, N).  The entries in params for SpNCCIResultsData
            ...
            self.energies (dictionary): Maps from quantum number tuple to energy.
                ...
                MFDnResultsData, the keys are of the form (J, g, n) (or MFDnStateData.qn).  
                For SpNCCIResultsData, they keys are of the form (hw, (J, gex, i)) (or
                SpNCCIStateData.qn)).  
